function TiffDir_out = FindTiffDir(CartDir_in)
...
TiffDir_out = 'No Tiff dir found';

while it < 10
    it = it + 1;
    if size(dir([CurrentDir filesep '*.tif']),1) > MinNumberOfTiffsNeeded
