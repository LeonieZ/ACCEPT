...
%% 
classdef Marker_Characterization_Mask < SampleProcessor
    ...
    methods 
        function this = Marker_Characterization_Mask()
            this.name = 'Marker Characterization with Mask';
            this.version = '0.1';  
        ...
        function run(this,inputSample)
            ...
            ac = ActiveContourSegmentation({'adaptive',0.001,0.005}, 200, 1,{'triangle','global', inputSample.histogram},this.maskForChannels);
            ac.clear_border = 1;
