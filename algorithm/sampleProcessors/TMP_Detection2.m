...
%             ts = ThresholdingSegmentation('triangle','global', inputSample.histogram, 3,10);
            ...
            if ~isempty(inputSample.results.features)
                ...
                inputSample.results.thumbnails(inputSample.results.features.ThumbNr(find(inputSample.results.features.ch_3_Area==0)),:) = [];
                inputSample.results.segmentation(inputSample.results.features.ThumbNr(find(inputSample.results.features.ch_3_Area==0))) = [];
